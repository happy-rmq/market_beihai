...
package com.lenovo.platform.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        Drawable drawable = getResources().getDrawable(R.drawable.qrcode_scan_line);
        if (drawable instanceof BitmapDrawable) {
            qrCodeScanLine = ((BitmapDrawable) drawable).getBitmap();
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            canvas.drawBitmap(qrCodeScanLine, null, lineRect, paint);
