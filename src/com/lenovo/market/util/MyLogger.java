 ...
 * 日志工具类
 * 
 * @author http://blog.csdn.net/kesenhoo/article/details/6996834
 */
public class MyLogger {

    private final static boolean logFlag = true;

    public final static String tag = "LenovoMarket";
    private final static int logLevel = Log.VERBOSE;
    private static Hashtable<String, MyLogger> sLoggerTable = new Hashtable<String, MyLogger>();
    private String mClassName;

    private static MyLogger comlog;
    private static MyLogger zylog;

    private static final String COMMON = "@common@ ";
    private static final String ZHOUYANG = "@zhouyang@ ";
     ...
     * @return
     */
    public static MyLogger zyLog() {
        if (zylog == null) {
            zylog = new MyLogger(ZHOUYANG);
        }
        return zylog;
    }
