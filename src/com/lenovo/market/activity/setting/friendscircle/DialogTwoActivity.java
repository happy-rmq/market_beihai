...
public class DialogTwoActivity extends BaseActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        case R.id.dialog_taking_bt:
            SendFriendSquarePicActivity.bleanCancel = false;
            getCamera();
            break;
        ...
        case R.id.btn_cancel:
            SendFriendSquarePicActivity.bleanCancel = true;
            finish();
            break;
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (file != null && resultCode < 0) {
            SendFriendSquarePicActivity.filePathT = file.getAbsolutePath();
            finish();
        }
        finish();
    }
