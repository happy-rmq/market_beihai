...
import com.lenovo.market.view.ScrollOverListView.OnScrollOverListener;
...
public class PullDownView extends LinearLayout implements OnScrollOverListener {
    ...
    /**
     * 通知已经获取完更多了，要放在Adapter.notifyDataSetChanged后面 当你执行完更多任务之后，调用这个notyfyDidMore() 才会隐藏加载圈等操作
     */
