...
public class CustomGallery extends Gallery {
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
        ...
        if (view instanceof CustomImageView) {
            ...
            if ((int) width <= PictureViewActivity.screenWidth && (int) height <= PictureViewActivity.screenHeight) {// 如果图片当前大小<屏幕大小，直接处理滑屏事件
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (view instanceof CustomImageView) {
                ...
                float width = imageView.getScale() * imageView.getImageWidth();
                float height = imageView.getScale() * imageView.getImageHeight();
                if ((int) width <= PictureViewActivity.screenWidth && (int) height <= PictureViewActivity.screenHeight) {// 如果图片当前大小<屏幕大小，判断边界
                    break;
                }
                float v[] = new float[9];
                Matrix m = imageView.getImageMatrix();
